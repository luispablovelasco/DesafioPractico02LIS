...
<body>
    ...
    <div class="container-md p-3 border border-1 rounded-3">
        ...
        <div class="row">
            ...
            <div class="col-4 mb-3">
                <input type="text" class="form-control" id="inputNota1" name="nota1">
            </div>
            <div class="col-4 mb-3">
                <input type="text" class="form-control" id="inputNota2" name="nota2">
            </div>
            <div class="col-4 mb-3">
                <input type="text" class="form-control" id="inputNota3" name="nota3">
            </div>
        </div>
