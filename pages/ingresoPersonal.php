    ...
    <div class="container-md p-3 border border-1 rounded-3">
        ...
        <div class="row">
            <div class="col-4 mb-3">
                ...
                <input type="text" class="form-control" id="inputDepend">
            </div>
            <div class="col-4 mb-3">
                <label for="inputFunc" class="form-label">Función que realiza:</label>
                <input type="text" class="form-control" id="inputFunc">
            </div>
            <div class="col-2 mb-3">
                <label for="inputAñosTrabajados" class="form-label">Años trabajados:</label>
                <input type="number" class="form-control" id="inputAñosTrabajados">
            </div>
        </div>
